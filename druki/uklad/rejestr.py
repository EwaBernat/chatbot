...
DYR = {
 ...
 'kafelki':[
  {'klucz':'planowanie','nazwa':'Planowanie pracy przedszkola','ikona':'🗺',
   'opis':'Osobny plan pracy dla każdego z pięciu typów placówki oraz dokument wychowawczo-profilaktyczny.',
   'druki':[('DW-1','Kacik_Dyrektora_Plany_Pracy_PCTP','Plan pracy przedszkola ogólnodostępnego'),
            ('DW-2','Kacik_Dyrektora_Plany_Pracy_PCTP','Plan pracy przedszkola integracyjnego'),
            ('DW-3','Kacik_Dyrektora_Plany_Pracy_PCTP','Plan pracy przedszkola z oddziałami integracyjnymi'),
            ('DW-4','Kacik_Dyrektora_Plany_Pracy_PCTP','Plan pracy przedszkola specjalnego'),
            ('DW-5','Kacik_Dyrektora_Plany_Pracy_PCTP','Plan pracy przedszkola z oddziałami specjalnymi'),
  ...
  {'klucz':'rada','nazwa':'Rada pedagogiczna','ikona':'👥',
   'opis':'Pięć obowiązkowych zebrań z protokołem, listą obecności i kworum; uchwały, zarządzenia i regulamin.',
   'druki':[('RP-1','Kacik_Dyrektora_Rada_Pedagogiczna_PCTP','Protokół zebrania rady z listą obecności'),
            ...
            ('RA-1','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Obowiązkowe rady — kalendarz i katalog kompetencji'),
            ('RA-2','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Rada organizacyjna przed rozpoczęciem roku'),
            ('RA-3','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Rada — plan nadzoru, do 15 września'),
            ('RA-4','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Rada półroczna — wnioski z nadzoru'),
            ('RA-5','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Rada po zakończeniu rocznych zajęć'),
            ('RA-6','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Rada — wyniki i wnioski z nadzoru, do 31 sierpnia'),
            ('RA-7','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Uchwały rady — wzór, rejestr i tryb wstrzymania'),
            ('RA-8','Kacik_Dyrektora_Rady_Pedagogiczne_KOMPLET_PCTP','Zwołanie rady, zarządzenia i kontrola dokumentacji')]},
