...
| [`Profil_sensoryczny/`](Profil_sensoryczny/README.md) | Profil sensoryczny (model Dunn) — obserwacja modulacji sensorycznej, 7 zmysłów | html + pdf | przebudowany na wspólny system PCTP (16→**9 stron**), charakterystyka jako tabelka w stylu ToM — do potwierdzenia |
