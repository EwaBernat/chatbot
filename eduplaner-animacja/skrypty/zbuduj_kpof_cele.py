...
@media print{.kreatorbtn,.moje button,.chipbtn,.fprzyciski .fbtn,.kclose{display:none!important}.fprzyciski{justify-content:flex-start}.druk-konspektu .kmodal.open~.kmodal.open{break-before:page;page-break-before:always}.druk-konspektu .kcard{break-inside:auto}.ktab tr,.kmod,.kcel{break-inside:avoid}}
"""
