...
POLECENIA = {
 ...
 ("IV.4", "B"): "Dostaniesz to, kiedy zadzwoni minutnik. Do tego czasu zrób zadanie z pudełka.",
 ...
 ("IV.5", "B"): "Zanim się zacznie, wybierz jedno zadanie z pudełka. Zrób je, zanim zadzwoni minutnik.",
 ...
 ("V.2", "B"): "Pokaż, jaki masz teraz kolor. Potem wybierz, co ci pomoże.",
 ("V.2", "C"): "Powiedz, co czujesz i dlaczego. Potem zrób to, co ci pomaga.",
 ...
 ("V.5", "C"): "Kiedy poczujesz, że robi się trudno, powiedz mi o tym. Potem weź trzy oddechy albo idź do kącika.",
}
