...
add(straznik(5, 'DOKUMENTACJA PRZEBIEGU WYCHOWANIA PRZEDSZKOLNEGO', [
  p([t('Akt: ', { bold: true }), t('Rozporządzenie Ministra Edukacji Narodowej z dnia 25 sierpnia 2017 r. w sprawie sposobu prowadzenia przez publiczne przedszkola, szkoły i placówki dokumentacji przebiegu nauczania, działalności wychowawczej i opiekuńczej oraz rodzajów tej dokumentacji — Dz.U. 2017 poz. 1646; tekst jednolity: '), t('Dz.U. 2024 poz. 50', { bold: true }), t('.')]),
...
add(straznik(6, 'OCHRONA DANYCH I PRZECHOWYWANIE DOKUMENTACJI', [
  p([t('Akty: ', { bold: true }), t('rozporządzenie Parlamentu Europejskiego i Rady (UE) 2016/679 (RODO), CELEX 32016R0679 — w szczególności art. 6 ust. 1 lit. c i e oraz art. 9 ust. 2 lit. g; ustawa z dnia 14 grudnia 2016 r. — Prawo oświatowe (tekst jedn. '), t('Dz.U. 2026 poz. 820', { bold: true }), t('); ustawa z dnia 14 lipca 1983 r. o narodowym zasobie archiwalnym i archiwach wraz z instrukcją kancelaryjną i jednolitym rzeczowym wykazem akt przyjętym w placówce.')]),
...
add(table(['Obszar', 'Stan do 31.08.2026 r.', 'Stan od 1.09.2026 r.', 'Co robimy inaczej'], [
  ...
  ['Zespoły orzekające',
   ...
   'Nowe składy zespołów, uproszczone wzory orzeczeń i opinii, orzeczenie podpisywane przez wszystkich członków zespołu (k.p.a.) — od 14.04.2026. Przepisy dotyczące przedszkola (§ 7 ust. 6–7 i § 8) — od 01.09.2026.',
   'Sprawdzamy, czy orzeczenia wpływające po 14 kwietnia 2026 r. mają nowy układ — inaczej wypełnia się z nich WOPF.'],
