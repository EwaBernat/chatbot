# Scenariusz filmu szkoleniowego — „Cele SMART w przedszkolu”
...
## Scena 1 · Otwarcie — dwa zdania, które robią różnicę

**Czas:** ok. 35 s (93 słowa) · **Plansza:** `plansze/00_tytul.png`

**Tekst na ekranie:** Cele SMART w przedszkolu · Zobaczyć · policzyć · obronić
...
## Scena 3 · Cel-życzenie kontra cel-narzędzie

**Czas:** ok. 50 s (129 słów) · **Plansza:** `plansze/01_zyczenie_narzedzie.png`

**Tekst na ekranie:** §1 · Po co · Zasada trzech osób
...
## Scena 4 · Pięć liter, pięć pytań kontrolnych

**Czas:** ok. 80 s (194 słowa) · **Plansza:** `plansze/02_piec_liter.png`

**Tekst na ekranie:** §2 · Anatomia · S · M · A · R · T
...
## Scena 5 · Sześć kroków od obserwacji do zapisu

**Czas:** ok. 105 s (267 słów) · **Plansza:** `plansze/03_szesc_krokow.png`

**Tekst na ekranie:** §3 · Skrypt · Najpierw patrzysz i liczysz, potem piszesz
...
## Scena 6 · Formuła zdania — tak wpisujesz cel

**Czas:** ok. 65 s (166 słów) · **Plansza:** `plansze/04_formula_zdania.png`

**Tekst na ekranie:** §4 · Formuła · Siedem pól, jedno zdanie
...
## Scena 7 · Bank czasowników

**Czas:** ok. 50 s (121 słów) · **Plansza:** `plansze/05_bank_czasownikow.png`

**Tekst na ekranie:** §5 · Słownik · Czasownik przesądza o mierzalności
...
## Scena 8 · Rozbiór celu wzorcowego i konspekt

**Czas:** ok. 90 s (221 słów) · **Plansza:** `plansze/06_termometr_rozbior.png`

**Tekst na ekranie:** §6 · Wzorzec · Termometr napięcia · ICF b1521
...
## Scena 9 · Dziewięć obszarów nowej podstawy

**Czas:** ok. 75 s (186 słów) · **Plansza:** `plansze/07_dziewiec_obszarow.png`

**Tekst na ekranie:** §7 · Bank celów · Obszar + numer osiągnięcia
...
## Scena 10 · Zielony, żółty, czerwony

**Czas:** ok. 75 s (191 słów) · **Plansza:** `plansze/08_ewaluacja.png`

**Tekst na ekranie:** §8 · Ewaluacja · Co zrobić z celem po punkcie kontrolnym
...
## Scena 11 · Checklista przed wpisaniem celu

**Czas:** ok. 80 s (194 słowa) · **Plansza:** `plansze/09_checklista.png`

**Tekst na ekranie:** §9 · Kontrola · Dziesięć pytań · pięć poprawek
...
## Scena 12 · Podstawa prawna

**Czas:** ok. 80 s (198 słów) · **Plansza:** `plansze/10_podstawa_prawna.png`

**Tekst na ekranie:** §10 · Prawo · Pięć aktów
...
**Tekst na ekranie:** Źródła · Doran · Mager · Kiresuk · Locke i Latham · WHO · IDEA
...
**Tekst na ekranie:** Mniej dokumentów. Więcej edukacji.
