...
.f-av .disc{position:absolute;inset:0;border-radius:50%;overflow:hidden;background:radial-gradient(circle at 40% 35%,#3B2A80,#1A1240 70%);box-shadow:0 20px 60px rgba(0,0,0,.5)}
