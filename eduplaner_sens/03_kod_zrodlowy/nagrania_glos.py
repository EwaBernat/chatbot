#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Nagrania poleceń dla dziecka — 63 pliki MP3 głosem autorki.

Buduje manifest nagrań z `pomoce_sens.json` i — na żądanie — generuje pliki MP3
...
GŁOS JEST DANĄ BIOMETRYCZNĄ. Pliki z katalogu audio_sens/ to sklonowany głos
...
POMOCE = KORZEN / "01_dane_json" / "pomoce_sens.json"
MANIFEST = KORZEN / "01_dane_json" / "nagrania_sens.json"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Nagrania poleceń dla dziecka — profil sensoryczny")
