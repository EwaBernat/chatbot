// Generator druku "Zakres czynności i obowiązków nauczyciela matematyki, wychowawcy oddziału
// klasy VI c w szkole specjalnej" – osobny egzemplarz dla każdego nauczyciela
// (Kodeks pracy, pełny wymiar 30 godzin tygodniowo).
...
//   node dokumenty/generuj_druk_matematyka_wychowawstwo.js logo.png dokumenty/druk-zakres-czynnosci-matematyka-wychowawstwo-6c.docx "Monika ………………"
const fs = require("fs");
const {
...
if (NAUCZYCIELE.length === 0) NAUCZYCIELE.push("Monika ………………");
...
function obowiazki() {
  ...
  return [
    ...
    w("Wybór lub opracowanie programu nauczania matematyki dostosowanego do potrzeb i możliwości uczniów oddziału oraz przedstawienie go dyrektorowi do dopuszczenia.", "art. 22a ustawy o systemie oświaty"),
    ...
    w("Opracowanie i stosowanie przedmiotowych zasad oceniania oraz wymagań edukacyjnych z matematyki dostosowanych do IPET każdego ucznia; poinformowanie o nich uczniów i rodziców na początku roku szkolnego.", "art. 44b ust. 8–9 ustawy o systemie oświaty"),
    ...
    w("Opieka nad pracownią matematyczną, pomocami dydaktycznymi i sprzętem: ewidencja, zgłaszanie potrzeb, udział w inwentaryzacji; odpowiedzialność materialna za mienie powierzone na piśmie.", "art. 124 Kodeksu pracy; statut szkoły"),
    w("Prowadzenie innych zajęć przydzielonych w planie lekcji zgodnie z posiadanymi kwalifikacjami (np. zajęcia dydaktyczno-wyrównawcze, koło matematyczne, zajęcia rewalidacyjne przy odpowiednich kwalifikacjach).", "§ 5 rozporządzenia w sprawie kształcenia specjalnego; rozporządzenie MEN w sprawie kwalifikacji nauczycieli (1.08.2017 r.)"),

    "IV. Wychowawstwo oddziału klasy VI c",
    ...
    "V. Kształcenie specjalne: IPET, WOPF, zespół (jako nauczyciel matematyki)",
    w("Udział w zespołach opracowujących IPET uczniów każdego oddziału, w którym nauczyciel uczy; wkład w części dotyczącej matematyki; opracowanie IPET do 30 września lub w ciągu 30 dni od otrzymania orzeczenia.", "§ 6 rozporządzenia w sprawie kształcenia specjalnego"),
    w("Wkład do wielospecjalistycznej oceny poziomu funkcjonowania ucznia (WOPF) co najmniej dwa razy w roku szkolnym w zakresie funkcjonowania na lekcjach matematyki; udział w ocenie efektywności i modyfikacji IPET.", "§ 6 rozporządzenia w sprawie kształcenia specjalnego"),
    ...
    "VII. Ocenianie, klasyfikacja i egzaminy",
    w("Ocenianie bieżące z matematyki: stopnie w skali 1–6 w oddziałach dla uczniów z niepełnosprawnością intelektualną w stopniu lekkim, oceny opisowe w oddziałach dla uczniów z niepełnosprawnością umiarkowaną lub znaczną; jawność ocen i ich uzasadnianie; sprawdziany dostosowane do IPET.", "art. 44e i art. 44i ust. 7 ustawy o systemie oświaty"),
    w("Ustalanie śródrocznych i rocznych ocen klasyfikacyjnych z matematyki; udział w klasyfikacji i uchwałach rady pedagogicznej o promowaniu, w tym uczniów z niepełnosprawnością umiarkowaną lub znaczną z uwzględnieniem IPET.", "art. 44f–44o ustawy o systemie oświaty"),
    ...
    "VIII. Współpraca z rodzicami (jako nauczyciel matematyki)",
    w("Prowadzenie konsultacji dla rodziców i uczniów w terminie ustalonym w rozkładzie czasu pracy; udział w zebraniach; komunikacja przez dziennik elektroniczny; informowanie o postępach i trudnościach z matematyki; instruktaż do ćwiczeń w domu.", "art. 44e i 44g ustawy o systemie oświaty; IPET; statut szkoły"),

    "IX. Praca zespołowa i współpraca z instytucjami",
    ...
    "X. Dokumentacja",
    w("Prowadzenie wpisów w dziennikach lekcyjnych każdego oddziału: tematy, frekwencja, oceny; jako wychowawca – całości dokumentacji oddziału klasy VI c.", "art. 14 ust. 3 pkt 5 Prawa oświatowego; rozporządzenie MEN w sprawie dokumentacji przebiegu nauczania (25.08.2017 r.)"),
    w("Opracowanie planów wynikowych (rozkładów materiału) matematyki dla każdego oddziału, przedmiotowych zasad oceniania, planu pracy wychowawcy; sprawozdania półroczne i roczne z realizacji przedmiotu i pracy wychowawczej.", "statut szkoły"),
    ...
    "XI. Przygotowanie do zajęć i doskonalenie zawodowe",
    w("Przygotowanie lekcji, materiałów dostosowanych (karty pracy, materiał manipulacyjny, pomoce wizualne, zadania o różnym poziomie trudności) i pracowni; sprawdzanie prac uczniów – w czasie przewidzianym na to w rozkładzie czasu pracy.", "art. 128 Kodeksu pracy; rozkład czasu pracy"),
    w("Doskonalenie zawodowe zgodnie z potrzebami szkoły: szkolenia rady pedagogicznej, kursy z dydaktyki matematyki dla uczniów z niepełnosprawnością intelektualną, AAC, pracy wychowawczej; realizacja ścieżki awansu zawodowego. Szkolenie na polecenie pracodawcy jest czasem pracy.", "art. 6 pkt 3 i 3a oraz art. 9a–9h Karty Nauczyciela (przez art. 91b KN); art. 94¹³ Kodeksu pracy"),
...
function egzemplarz(nazwisko, logo, pierwszy) {
  const naglowekDok = new Table({
    ...
    rows: [new TableRow({ children: [
      ...
      new TableCell({ width: { size: SZER - 1100, type: WidthType.DXA }, borders: bezRamek, verticalAlign: VerticalAlign.CENTER, children: [
        ...
        new Paragraph({ spacing: { after: 0 }, children: [run("nauczyciela matematyki, wychowawcy klasy VI c w szkole specjalnej · rok szkolny " + ROK, { size: 19, color: POMARANCZ })] }),
      ] }),
    ] })],
  });
  ...
  const dane = tabela(null, [
    ...
    ["Stanowisko", "nauczyciel matematyki w szkole podstawowej specjalnej; wychowawca oddziału klasy VI c"],
    ["Nauczane przedmioty i klasy", "matematyka: klasy ………………………   inne zajęcia przydzielone w planie lekcji: ………………………   (oddziały dla uczniów z niepełnosprawnością intelektualną w stopniu lekkim; w oddziałach dla uczniów z niepełnosprawnością umiarkowaną lub znaczną – treści matematyczne w ramach funkcjonowania osobistego i społecznego)"],
    ["Wychowawstwo", "oddział klasy VI c – wychowawca; zajęcia z wychowawcą 1 godzina tygodniowo w planie lekcji; koordynowanie zespołu ds. IPET uczniów oddziału"],
  ...
  const odpow = tabela(["Zakres odpowiedzialności", "Podstawa"], [
    ...
    ["Za mienie powierzone na piśmie (pracownia, pomoce, sala oddziału).", "art. 124 Kodeksu pracy"],
...
const naglowek = new Header({ children: [new Paragraph({
  ...
  children: [new ImageRun({ type: "png", data: logo, transformation: { width: 22, height: 22 } }), run("   " + PLACOWKA, { size: 15, color: SZARY }), run("\tZakres czynności – matematyka, wychowawstwo klasy VI c – " + ROK, { size: 15, color: FIOLET })],
})] });
...
const doc = new Document({
  creator: PLACOWKA, title: "Zakres czynności nauczyciela matematyki, wychowawcy klasy VI c " + ROK,
